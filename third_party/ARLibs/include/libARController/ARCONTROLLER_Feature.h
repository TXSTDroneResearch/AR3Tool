 ...
 * return executing error
 */
eARCONTROLLER_ERROR ARCONTROLLER_ARDrone3_SendCameraOrientationV2Struct (ARCONTROLLER_FEATURE_ARDrone3_t *feature, uint8_t *cmdBuffer, int32_t cmdBufferSize);
 ...
 * return executing error
 */
eARCONTROLLER_ERROR ARCONTROLLER_ARDrone3_SendCameraVelocityStruct (ARCONTROLLER_FEATURE_ARDrone3_t *feature, uint8_t *cmdBuffer, int32_t cmdBufferSize);
